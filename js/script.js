...
const displayPopularMovies = async function () {
...
const displayPopularShows = async function () {
...
//Information when user click on single movie
...
//Information when user click on single TV show
...
const displayPagination = function () {
  ...
  //Desable prev btn if on first page
  if (global.search.page === 1) {
    document.querySelector("#prev").disabled = true;
  }

  //Desable next btn if on last page
...
//Show Alert
const showAlert = function (message, className = "error") {
